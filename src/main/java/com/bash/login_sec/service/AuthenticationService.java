...
import com.bash.login_sec.dto.VerifyUserDto;
...
public class AuthenticationService {
    ...
    public User authenticate(LoginUserDto input){
        ...
        if(!user.isEnabled()){ throw new RuntimeException("Account is not verified. Please verify your account");}
    ...
    private void sendVerificationEmail(User user) {
        ...
        try {
            emailService.sendMail(user.getEmail(), subject, htmlMessage);
